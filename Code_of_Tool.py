...
loaded_model=pickle.load(open("C:/Users/Smadi/Desktop/Githup/TrainedModel.sav",'rb'))
...
def main():
    ...
    #some of examples to help user
    with st.expander('EXAMPLE PHISHING URLs:'):
        st.write('http://www.u1903007.cp.regruhosting.ru/')
        st.write('https://meta-case-id8759235.meta-appeals.com/1.php')
        st.caption('REMEMBER, PHISHING WEB PAGES HAVE SHORT LIFECYCLE! SO, THE EXAMPLES SHOULD BE UPDATED!')
    #getting the input data from the user
    url = st.text_input('Enter the URL')
    #to store result
    result=""
    # creating a button for predicaion
    if st.button('Check!'):
        #sent url to model
        obj = FeatureExtraction(url)
        features=obj.getFeaturesList()
        import numpy as np
        #changing the features to numpy array
